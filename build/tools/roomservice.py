...
custom_local_manifest = ".repo/local_manifests/wrath.xml"
custom_default_revision = "ten"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'ten')
custom_dependencies = "wrath.dependencies"
org_manifest = "wrath-devices"  # leave empty if org is provided in manifest
org_display = "WrathOS-Devices"  # needed for displaying
