...
ALARM_PATH := vendor/wrath/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/wrath/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/wrath/prebuilt/common/media/audio/ringtones
